...
export const editorTheme = EditorView.theme(
  {
    ...
    '.cm-cursor': { borderLeftColor: '#e6b64c', borderLeftWidth: '2px' },
    '.cm-selectionBackground': { backgroundColor: 'rgba(230,182,76,0.22) !important' },
    '&.cm-focused .cm-selectionBackground': { backgroundColor: 'rgba(230,182,76,0.26) !important' },
    ...
    '.cm-activeLineGutter': { backgroundColor: 'transparent', color: '#c9cfd9' },
    '.cm-line': { padding: '0 10px' },
    '.syn-section': { color: '#99a3b2', fontWeight: '700', letterSpacing: '0.06em' },
    '.syn-camera': { color: '#5cbecf' },
    '.syn-lighting': { color: '#e6b64c' },
    '.syn-color': { color: '#cf8ecf' },
    '.syn-motion': { color: '#71c584' },
    '.syn-mood': { color: '#a394ff' },
    '.syn-technical': { color: '#7fa8ef' },
    '.syn-timecode': {
      color: '#f5cd66',
      fontWeight: '650',
      backgroundColor: 'rgba(230,182,76,0.09)',
      borderRadius: '3px',
      padding: '0 2px'
    },
    '.cm-lockedLine': { backgroundColor: 'rgba(230,182,76,0.055)' },
